...
dict = {}
temp = []
with open('computer_catagory.txt','r') as f:
    for line in f:
        temp.append(line.strip().replace(' ',"_"))

category = ['Adult','Arts','Business','Computers','Games','Reference','Regional','Science','Shopping','Society','Health','Home','Kids_and_Teens','News',
